...
const actionActions = [
    ...
    actionButtonAction('sneeze', '打喷嚏', 5 /* Sneeze */),
    actionButtonAction('sleep', '睡觉', 13 /* Sleep */),
    actionButtonAction('yawn', '打哈欠', 3 /* Yawn */),
    actionButtonAction('love', '示爱', 18 /* Love */),
    actionButtonAction('laugh', '大笑', 4 /* Laugh */),
    actionButtonAction('blush', '脸红', 16 /* Blush */),
    actionButtonAction('drop', '丢物品', 14 /* Drop */),
    actionButtonAction('drop-toy', '丢玩具', 15 /* DropToy */),
    actionButtonAction('magic', '魔法', 26 /* Magic */),
    actionButtonAction('switch-tool', '切换工具', 29 /* SwitchTool */),
