...
// 占位实体
registerMix(n('null'), () => { throw new Error('无效类型 (0)'); });
// 实体
...
exports.placeableEntities = [
    { type: exports.cushion1.type, name: '坐垫 (红色)' },
    { type: exports.cushion2.type, name: '坐垫 (蓝色)' },
    { type: exports.cushion3.type, name: '坐垫 (绿色)' },
    { type: exports.barrel.type, name: '木桶' },
    { type: exports.box.type, name: '箱子' },
    { type: exports.boxLanterns.type, name: '提灯箱' },
    { type: exports.boxFruits.type, name: '水果箱' },
    { type: exports.cookieTable2.type, name: '饼干桌' },
    { type: exports.table1.type, name: '小桌子' },
    { type: exports.table2.type, name: '大桌子' },
    { type: exports.table3.type, name: '长桌子' },
    { type: exports.lanternOn.type, name: '提灯' },
    { type: exports.pumpkin.type, name: '南瓜' },
    { type: exports.jackoOn.type, name: '南瓜灯 (点亮)' },
    { type: exports.jackoOff.type, name: '南瓜灯 (熄灭)' },
    { type: exports.crate1A.type, name: '大箱子' },
    { type: exports.crate3A.type, name: '小箱子' },
    { type: exports.crate2A.type, name: '保险箱' },
    { type: exports.largeLeafedBush1.type, name: '大盆栽' },
    { type: exports.largeLeafedBush3.type, name: '小盆栽' },
    { type: exports.picture1.type, name: '画 (1)' },
    { type: exports.picture2.type, name: '画 (2)' },
    { type: exports.window1.type, name: '窗户' },
    { type: exports.bookshelf.type, name: '书架' },
    { type: exports.rock.type, name: '岩石' },
];
exports.fruits = [
...
exports.tools = [
    { type: exports.saw.type, text: '锯子: 放置和移除墙壁' },
    { type: exports.broom.type, text: '扫帚: 移除家具' },
    { type: exports.hammer.type, text: '锤子: 放置家具\n使用 [鼠标滚轮] 切换物品' },
    { type: exports.shovel.type, text: '铲子: 更改地板\n使用 [鼠标滚轮] 切换地板类型' },
];
...
if (DEVELOPMENT) {
    if (exports.pony.type !== constants_1.PONY_TYPE) {
        throw new Error(`无效的小马类型 ${exports.pony.type} !== ${constants_1.PONY_TYPE}`);
    }
        ...
        if (entity.colliders) {
            ...
            for (const { x, y, w, h } of entity.colliders) {
                if ((x < -maxWidth || (x + w) > maxWidth || y < -maxHeight || (y + h) > maxHeight)) {
                    throw new Error(`无效实体 "${name}": 碰撞器过大 ${JSON.stringify({ x, y, w, h })}`);
                }
            }
        }
    }
