...
function createIslandMap(world, instanced, template = false) {
    ...
    entityUtils_1.setEntityName(boxOfFruits, '水果箱');
    ...
    entityUtils_1.setEntityName(giftPile, '玩具堆');
    ...
    entityUtils_1.setEntityName(itemSign, '物品堆');
    ...
    add(controllerUtils_1.createSignWithText(43, 23.5, '返回陆地', `跳上船返回大陆`));
    for (let y = 0; y < 10; y++) {
        const minX = y < 5 ? 0 : 1;
        const maxX = (y % 2) ? 4 : 3;
