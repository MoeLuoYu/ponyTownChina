...
export const houseTiles = [
	{ type: TileType.Dirt, name: '泥土' },
	{ type: TileType.Wood, name: '木头' },
	{ type: TileType.Grass, name: '草地' },
	{ type: TileType.Water, name: '水' },
	{ type: TileType.Ice, name: '冰' },
	{ type: TileType.Stone, name: '石头' },
	{ type: TileType.Stone2, name: '砖块' },
];
