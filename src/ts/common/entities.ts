...
export const placeableEntities: { type: number; name: string; }[] = [
	{ type: cushion1.type, name: '坐垫 (红色)' },
	{ type: cushion2.type, name: '坐垫 (蓝色)' },
	{ type: cushion3.type, name: '坐垫 (绿色)' },
	{ type: barrel.type, name: '木桶' },
	{ type: box.type, name: '箱子' },
	{ type: boxLanterns.type, name: '提灯箱' },
	{ type: boxFruits.type, name: '水果箱' },
	{ type: cookieTable2.type, name: '饼干桌' },
	{ type: table1.type, name: '小桌子' },
	{ type: table2.type, name: '大桌子' },
	{ type: table3.type, name: '长桌子' },
	{ type: lanternOn.type, name: '提灯' },
	{ type: pumpkin.type, name: '南瓜' },
	{ type: jackoOn.type, name: '南瓜灯 (点亮)' },
	{ type: jackoOff.type, name: '南瓜灯 (熄灭)' },
	{ type: crate1A.type, name: '大箱子' },
	{ type: crate3A.type, name: '小箱子' },
	{ type: crate2A.type, name: '保险箱' },
	{ type: largeLeafedBush1.type, name: '大盆栽' },
	{ type: largeLeafedBush3.type, name: '小盆栽' },
	{ type: picture1.type, name: '画 (1)' },
	{ type: picture2.type, name: '画 (2)' },
	{ type: window1.type, name: '窗户' },
	{ type: bookshelf.type, name: '书架' },
	{ type: rock.type, name: '岩石' },
];
...
export const tools = [
	{ type: saw.type, text: '锯子: 放置和移除墙壁' },
	{ type: broom.type, text: '扫帚: 移除家具' },
	{ type: hammer.type, text: '锤子: 放置家具\n使用 [鼠标滚轮] 切换物品' },
	{ type: shovel.type, text: '铲子: 更改地板\n使用 [鼠标滚轮] 切换地板类型' },
];
...
if (DEVELOPMENT) {
	if (pony.type !== PONY_TYPE) {
		throw new Error(`无效的小马类型 ${pony.type} !== ${PONY_TYPE}`);
	}
