...
export function expressionButtonAction(expression: Expression | undefined): ExpressionButtonAction {
	return { type: 'expression', expression, title: expression ? '' : '重置表情' };
}
...
const actionActions = [
	actionButtonAction('boop', '戳一下'),
	actionButtonAction('down', '坐下 / 降落'),
	actionButtonAction('up', '站起 / 飞起'),
	actionButtonAction('turn-head', '转头'),
	actionButtonAction('sneeze', '打喷嚏', Action.Sneeze),
	actionButtonAction('sleep', '睡觉', Action.Sleep),
	actionButtonAction('yawn', '打哈欠', Action.Yawn),
	actionButtonAction('love', '示爱', Action.Love),
	actionButtonAction('laugh', '大笑', Action.Laugh),
	actionButtonAction('blush', '脸红', Action.Blush),
	actionButtonAction('drop', '丢物品', Action.Drop),
	actionButtonAction('drop-toy', '丢玩具', Action.DropToy),
	actionButtonAction('magic', '魔法', Action.Magic),
	actionButtonAction('switch-tool', '切换工具', Action.SwitchTool),
	actionButtonAction('switch-entity', '切换放置物品'),
	actionButtonAction('switch-entity-rev', '反向切换放置物品'),
	actionButtonAction('switch-tile', '切换放置地砖'),
];
